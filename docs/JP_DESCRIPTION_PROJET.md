...
|---|---|
| **Nom** | JP — *Je prends* |
| **Signature** | Le direct devient une boutique. |
| **Marché** | Madagascar — mode, beauté, chaussures |
| **Nature** | Plateforme mobile de vente en direct, de contenu achetable et de paiement protégé |
| **Version** | 1.0 · Août 2026 |
| **Objet** | Présenter le projet dans son ensemble : la vision, le produit, le modèle, la feuille de route, l'organisation et le budget. |

> **Aucun chiffre de ce document n'est présenté comme acquis.** Les valeurs numériques sont des hypothèses à valider pendant le pilote. Les prestataires de paiement et de livraison sont cités comme partenaires *visés* : aucun accord n'est signé à ce jour.
...
# 3. Ce que nous vendons, acteur par acteur

Trois acteurs, trois discours. Ils ne sont pas interchangeables.

## 3.1 À l'acheteuse : « ton argent n'est pas perdu »

Son blocage n'est pas la friction, c'est la peur. Envoyer le prix d'une robe en mobile money vers un numéro inconnu, ce n'est pas un geste anodin : c'est une part réelle du budget du mois. Et se faire avoir, ce n'est pas seulement perdre de l'argent — c'est devoir l'avouer, c'est la honte.
...
1. les « je prends » qui ne paient jamais ;
...
- **Score de confiance public**, construit sur les ventes honorées, les délais et les litiges.
- **Protection des personnes** — filtrage des commentaires, restriction à l'initiative de l'autrice, signalement en un geste, traitement prioritaire du harcèlement.

## 4.2 Deux modes d'achat

**Le direct** est le canal d'acquisition : le pic, l'émotion, l'urgence réelle.
**Le catalogue et le contenu** sont le canal de répétition : la vitrine ouverte 24 h/24, le clip qui vend encore une semaine plus tard.

Les deux se nourrissent. Ce qui a été montré en direct continue de se vendre ensuite.

## 4.3 Deux modes de livraison

**À domicile** — adresse enregistrée une fois, suivi partagé.
**En point de retrait** — moins cher, sans rendez-vous, **et sans avoir à donner son adresse personnelle**.

Le point relais n'est pas un confort : c'est **ce qui rend le petit panier économiquement viable**, donc ce qui rend la fréquence d'achat possible.

## 4.4 Le cadeau et la diaspora

L'acheteuse compose son panier, envoie un lien, quelqu'un d'autre paie — y compris depuis l'étranger, par carte. Elle reçoit, elle publie son remerciement, le remerciement devient du contenu.

C'est le premier canal de JP **qui ne dépend pas du pouvoir d'achat local**, sur des paniers structurellement plus élevés. Et c'est une réponse à un usage massif aujourd'hui aveugle : la diaspora envoie de l'argent sans jamais savoir ce qui en est fait. Offrir un objet précis, vérifié, livré, avec une preuve, est une proposition nouvelle.

## 4.5 Pourquoi la mode et la beauté
...
# 5. Ce que personne ne fait sur ce marché
...
7. **Le cadeau depuis l'étranger.** Offrir un objet précis, pas envoyer de l'argent.
8. **Le point de retrait sans adresse.** Ce qui rend le petit panier viable.
...
| 8 | **Régie publicitaire** | Annonceurs locaux. **Volontairement en dernier.** | À l'échelle |

## 6.1 Une mise au point sur la publicité

La publicité display classique ne rapporte presque rien à l'échelle de Madagascar : le CPM sur une audience malgache est dérisoire, et il faut des dizaines de millions d'impressions pour dégager un revenu significatif. À ce niveau d'audience, la commission sur les ventes rapporte déjà bien davantage : quelques pour cent sur un panier ordinaire valent mieux que des dizaines de milliers d'affichages. *(Ordre de grandeur, à confirmer avec les régies locales.)*

**La couche sociale se monétise donc par le commerce qu'elle déclenche, pas par l'attention qu'elle capte.** C'est plus rentable, c'est plus défendable, et cela ne dégrade pas l'expérience — ce qui compte quand l'actif principal est la confiance.
...
# 7. Ce qui rend le projet défendable
...
# 9. Le lancement : où est le risque, et où va l'argent
...
| **Infrastructure vidéo** | Transcodage, stockage, diffusion. Poste le plus difficile à prévoir. | Variable |
| **Frais de paiement** | Commissions des prestataires | Variable |
| **Logistique** | Constitution du réseau de points relais, livraison | Moyen |
| **Juridique** | Cadrage de la conservation de fonds, conditions générales, données personnelles | Ponctuel |

## 9.2 Ce que nous demandons

> **Un budget de lancement, pas un budget de développement.**

Le montant se cale avec le plan retenu. Deux scénarios peuvent être chiffrés et comparés : **une version resserrée sur une seule ville**, ou **une ouverture plus large**. C'est précisément la discussion que nous voulons avoir.
...
## 11.1 Les quatre mesures fondatrices

Jamais mesurées sur ce marché. **Les instrumenter est un objectif du projet en soi**, disponibles dès le premier direct.
...
# 12. Nos engagements de conception

Ces règles sont des choix économiques autant qu'éthiques. Sur un produit dont l'actif unique est la confiance, une manipulation découverte détruit plus de valeur qu'elle n'en crée.

- **Toute rareté affichée est réelle.** Pas de faux compte à rebours, pas de stock minoré, pas de compteur d'audience gonflé.
...
Le dossier ne cache pas ses questions non résolues — c'est précisément ce qu'un partenaire sérieux cherche à connaître avant de s'engager.

**Bloquant** — aucun accord de paiement ni de livraison n'est signé.
...
*Documents liés : `JP_POSITIONNEMENT.md` · `JP_EXPRESSION_DE_BESOIN.md` · `JP_BACKLOG.md` · `JP_CAHIER_DES_CHARGES.md` · `JP_CDC_TECHNIQUE.md` · `JP_DECK.md`*
